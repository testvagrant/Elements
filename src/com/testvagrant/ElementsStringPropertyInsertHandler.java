...
/**
 * Created by krishnanand on 23/06/17.
 */
public class ElementsStringPropertyInsertHandler implements InsertHandler<LookupElement> {

    private final String myNewValue;

    public ElementsStringPropertyInsertHandler(@NotNull String newValue) {
        myNewValue = newValue;
    }
